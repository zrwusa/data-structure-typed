...
[data-structure-typed](../index.md) / MaxHeap

# Class: MaxHeap\<E, R\>

Defined in: [data-structures/heap/max-heap.ts:73](https://github.com/zrwusa/data-structure-typed/blob/a9d6c9abc866183924585a6b636a09d910191f5d/src/data-structures/heap/max-heap.ts#L73)
...
Defined in: [data-structures/heap/max-heap.ts:79](https://github.com/zrwusa/data-structure-typed/blob/a9d6c9abc866183924585a6b636a09d910191f5d/src/data-structures/heap/max-heap.ts#L79)
...
```ts
console.log(new MaxHeap<number>().isEmpty()); // true
```
