 ...
 *     ]);
 *
 *     console.log(mm.ceiling(15)); // [20, ['b']];
 *     console.log(mm.ceiling(20)); // [20, ['b']];
   */
 ...
 *     ]);
 *
 *     console.log(mm.floor(25)); // [20, ['b']];
 *     console.log(mm.floor(5)); // undefined;
   */
