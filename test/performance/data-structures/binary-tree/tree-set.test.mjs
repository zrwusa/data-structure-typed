...
suite
  ...
  .add(`${N_ADD.toLocaleString()} add (DST classic)`, function () {
  ...
  .add(`${N_QUERY.toLocaleString()} has (DST classic)`, function () {
  ...
  .add(`${N_RANGE.toLocaleString()} rangeSearch (DST classic)`, function () {
  ...
  .add(`${N_RANGE.toLocaleString()} navigable (DST classic)`, function () {
    for (let i = 0; i < N_RANGE; i++) {
